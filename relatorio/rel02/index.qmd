...
## Passos iniciais para a utilização do R
 ...
 Precisamos primeiramente fazer o download da interface R e logo após, o download da interface do R studio, que interpretará através de comandos pré estabelecidos por funções, que converterá a sintaxe da linguagem ao que foi almejado.
...
```
 ...
 Até o presente momento existem 24 tipos de objetos datados.
