...
## 📊  Objetos, funções e estrutura de dados
...
### Funções no R
  ...
  **Nome:** Identifica o que a função faz Exemplo: **mean** para média, **plot** para gráfico.
...
#### Tipos de Funções no R
  ...
  **A) Funções Nativa (Built-in):** São as que já vêm instaladas no R. Exemplos que você usou ou usará: ``sum(dados)``: Soma valores.
...
#### Como pedir ajuda sobre uma função?
...
length(x)
```
 Existem diversas outras funções para se determinar diversos atributos de objetos, que são exploradas no curso Documentação em R @deivide2026docr, do professor Ben Dêivide.
...
## 🧠 Considerações finais
 ...
 Finalizamos este curso com o domínio das ferramentas essenciais do R. graças à metodologia do Professor Ben Dêivide, saímos com uma base sólida em objetos, funções e lógica de scripts. Estamos prontos para aplicar esses conhecimentos em nossos projetos e continuar explorando o vasto ecossistema de pacotes que o R oferece para a pesquisa e o mercado. Recomendo o curso de Documentaçao em R @deivide2026docr, também ministrado pelo professor Ben Dêivide, afim de conhecer a ferramenta Rmarkdown, essencial para melhor documentação, análise e interpretação estatística de dados dentro do R Studio.
